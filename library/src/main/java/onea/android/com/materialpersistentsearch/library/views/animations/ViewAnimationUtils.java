package onea.android.com.materialpersistentsearch.library.views.animations;
...
public final class ViewAnimationUtils {
  ...
  public static SupportAnimator createCircularReveal(View view,
    ...
    reveal.addListener((Animator.AnimatorListener) getRevealFinishListener(revealLayout));

    return new SupportAnimatorPreL(reveal, revealLayout);
  }

  private static SupportAnimator.AnimatorListener getRevealFinishListener(RevealAnimator target) {
    if (SDK_INT >= 18) {
